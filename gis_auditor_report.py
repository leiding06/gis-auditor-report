...
class GISAuditorReport:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'GISAuditorReport_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&GIS Auditor Report')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('GISAuditorReport', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/gis_auditor_report/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u''),
            callback=self.run,
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            self.dlg = GISAuditorReportDialog()
