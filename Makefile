...
SOURCES = \
	__init__.py \
	gis_auditor_report.py gis_auditor_report_dialog.py

PLUGINNAME = gis_auditor_report

PY_FILES = \
	__init__.py \
	gis_auditor_report.py gis_auditor_report_dialog.py

UI_FILES = gis_auditor_report_dialog_base.ui
...
QGISDIR=C:\Users\lleid\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
